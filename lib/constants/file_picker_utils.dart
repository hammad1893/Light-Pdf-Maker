...
//         if (sdkInt >= 30) {
//           granted = await _checkPermission(Permission.manageExternalStorage);
//         } else {
//           granted = await _checkPermission(Permission.storage);
//         }
...
//         Navigator.pop(context); // remove loader
//         bool granted = await _checkPermission(Permission.photos);
